...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootswatch/3.3.4/yeti/bootstrap.min.css" media="screen">
    <script>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="download">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="./bootstrap.min.css">bootstrap.min.css</a>
                <a class="dropdown-item" href="./bootstrap.css">bootstrap.css</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="./_variables.scss">_variables.scss</a>
                <a class="dropdown-item" href="./_bootswatch.scss">_bootswatch.scss</a>
              </div>
            </li>
          </ul>
      ...
      <div class="page-header" id="banner">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-5 col-sm-6">
            <div class="sponsor">
              <a href="http://www.shopify.com/?ref=bootswatch">
                <img src="../assets/img/shopify-300x250-light@2x.jpg">
              </a>
            </div>
          </div>
        </div>
